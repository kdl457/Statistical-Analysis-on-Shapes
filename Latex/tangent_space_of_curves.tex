...
\begin{center}
  \begin{tikzpicture}
    \begin{axis}[axis lines=none, axis equal,
      ...
      \addplot[gray, domain=0:360,samples=200]({7 +
        (1-0.8*cos(x*2)/2)*1.8*sin(x)},{(1-sin(x*4)/2)*1.8*cos(x)});
      \addplot[gray, domain=0:360,samples=200]({7 +
        (1-0.6*cos(x*2)/2)*1.8*sin(x)},{(1-sin(x*4)/2)*1.8*cos(x)});
      \addplot[gray, domain=0:360,samples=200]({7 +
        (1-0.4*cos(x*2)/2)*1.8*sin(x)},{(1-sin(x*4)/2)*1.8*cos(x)});
      \addplot[gray, domain=0:360,samples=200]({7 +
        (1-0.2*cos(x*2)/2)*1.8*sin(x)},{(1-sin(x*4)/2)*1.8*cos(x)});
      \addplot[domain=0:360,samples=200]({7 +
        (1-0*cos(x*2)/2)*1.8*sin(x)},{(1-sin(x*4)/2)*1.8*cos(x)});
